...
export default function RequestModal({ open, value, onClose, onApply }: IProps) {
      ...
      <div className={styles.sheet}>
            ...
            >
              ...
              {selected === opt && (
                <span className={styles.check} aria-hidden>
                  <Image src="/icons/check.svg" alt="체크" width={24} height={24} />
                </span>
              )}
            </button>
          ))}
        ...
        <div className={styles.footer}>
          <button
            ...
            disabled={!canApply}
            onClick={() => {
              const next = selected === '요청사항 없음' ? '' : isCustom ? custom.trim() : selected;
              onApply(next);
              onClose();
            }}
          >
