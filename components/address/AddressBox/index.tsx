...
export default function AddressBox({ selectedAddress, onOpenModal, onOpenRequestModal }: IProps) {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.address_box}>
        ...
        <div className={styles.header}>
          ...
          <button className={styles.change_btn} onClick={onOpenModal}>
            <p className={styles.text_lookup}>주소 변경</p>
          </button>
        </div>
          ...
          <>
            <div className={styles.table}>
              ...
              <div className={styles.value}>
                {selectedAddress.phone && phonePattern.test(selectedAddress.phone)
              ...
              <div className={styles.value}>
                ({selectedAddress.address.zipCode}) {selectedAddress.address.main} {selectedAddress.detail}
              </div>
            </div>
