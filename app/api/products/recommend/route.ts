import { GetRecommendProductsUseCase } from '@/backend/products/applications/usecases/GetRecomendProducts';
...
export async function GET() {
  try {
    ...
    const products = await new GetRecommendProductsUseCase(productRepository).execute();
