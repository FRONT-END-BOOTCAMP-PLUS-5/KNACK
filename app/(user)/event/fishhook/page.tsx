          ...
          <div className={styles.cont}>
            ...
            <div className={`${styles.bg} ${styles.bg2} ${bg2Active ? styles.on : ''}`}>
              <div className={styles.fish_up}>
                <Image 
                  src="/images/event/hippocampus.png" 
                  alt="해마"
                  width={26}
                  height={26}
                />
              ...
              <div className={`${styles.fish_left} ${styles.left1}`}>
                <Image 
                  src="/images/event/flying_fish1.png" 
                  alt="날치1"
                  width={32}
                  height={32}
                />
              ...
              <div className={`${styles.fish_right} ${styles.right1}`}>
                <Image 
                  src="/images/event/flying_fish2.png" 
                  alt="날치2"
                  width={51}
                  height={51}
                />
              ...
              <div className={`${styles.fish_right} ${styles.right2}`}>
                <Image 
                  src="/images/event/stripe_fish.png" 
                  alt="줄무늬물고기"
                  width={40}
                  height={40}
                />
              ...
              <div className={styles.loop_box}>
                <div className={styles.fishing_line}>
                  <Image 
                    src="/images/event/fishing_line.png" 
                    alt="낚시줄"
                    width={5}
                    height={340}
                  />
                ...
                <div className={styles.fishing_hook}>
                  <Image 
                    src="/images/event/fishing_hook.png" 
                    alt="낚시바늘"
                    width={43}
                    height={43}
                  />
            ...
            <div className={`${styles.bg} ${styles.bg3} ${bg3Active ? styles.on : ''}`}>
              ...
              <div className={styles.crucian_carp}>
                <Image 
                  src="/images/event/crucian_carp.png" 
                  alt="붉은물고기"
                  width={440}
                  height={200}
                />
